                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="getData">
                            <span>分析タイプ</span><br>
                            <input type="radio" v-model="form.type" value="perDay" checked><span class="mt-3 mr-2"> 日別</span>
                            <input type="radio" v-model="form.type" value="perMonth"><span class="mt-3 mr-2"> 月別</span>
                            <input type="radio" v-model="form.type" value="perYear"><span class="mt-3 mr-2"> 年別</span>
                            <input type="radio" v-model="form.type" value="decile"><span class="mt-3 mr-2"> デシル分析</span>
                            <input type="radio" v-model="form.type" value="rfm"><span class="mt-3 mr-2"> RFM分析</span><br>
                            From: <input type="date" name="startDate" class="mt-3" v-model="form.startDate">
                            ...
                            <button class="text-white bg-indigo-500 border-0 mt-4 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">分析する</button>
                        </form>
